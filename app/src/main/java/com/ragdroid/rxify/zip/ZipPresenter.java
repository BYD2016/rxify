...
public final class ZipPresenter extends AbstractPresenter<ZipContract.View> implements
        ZipContract.Presenter {
    ...
    public void preparePolyjuice() {
        ...
        disposable = Observable.zip(
                ...
                .subscribe(polyJuice -> {
                    ZipContract.View view1 = getView();
                    if (view1 != null) {
                        view1.showPolyJuice(zipData);
                    }
                });
